...
import os as os
__all__ = ['core', 'exceptions', 'os', 'read_from_file', 'read_from_string', 'versioning', 'write_to_file', 'write_to_string']
...
def write_to_string(input_otio, target_schema_versions = None, indent = 4):
    ...
    """
_DEFAULT_VERSION_ENVVAR: str = 'OTIO_DEFAULT_TARGET_VERSION_FAMILY_LABEL'
